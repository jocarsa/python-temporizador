...
font_thickness = 10  # Bold thickness for filled text
...
def create_timer_video(duration):
    ...
    for t in range(duration, -1, -1):  # Adjusted to include 00:00:00
        ...
        # Put the text on the image (filled text)
        cv2.putText(img, time_remaining, (text_x, text_y), font, max_scale, font_color, font_thickness, lineType=cv2.LINE_AA)
